...
'Define the variable of the worksheet to execute the code in all worksheet at once in the workbook

Dim ws As Worksheet

' Initiate or loop in all worksheet to execute the code once
'--------------------------------------------------
...
For Each ws In Worksheets
    ...
    EndRow = ws.Cells(Rows.Count, "A").End(xlUp).Row
        ...
        For i = 2 To EndRow
            ...
            'If Tickersymbol changes or not equal to the previous one execute to record
            ...
            ' Get the value first-day open from the column 3 or "C" and the last day close of the year on column 6 or "F"
