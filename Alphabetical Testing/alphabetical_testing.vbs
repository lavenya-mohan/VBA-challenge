...
'Define the variable of the worksheet to execute the code in all worksheets at once in the workbook

Dim ws As Worksheet

' Initiate or loop in all worksheets to execute the code once
'--------------------------------------------------

For Each ws In Worksheets

    'Assign a column header for every task we are going to perform
    ...
    EndRow = ws.Cells(Rows.Count, "A").End(xlUp).Row
        ...
        For i = 2 To EndRow
            ...
            'If Ticker symbol changes or is not equal to the previous one execute to record
            ...
            ' Get the value first-day open from column 3 or "C" and the last day close of the year on column 6 or "F"
